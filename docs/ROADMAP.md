...
Release and rollback validation aligns Cargo and AppStream versions, verifies required runtime assets, and rejects rollback targets that cannot read the current D-Bus or persistent-data formats. It does not execute a downgrade.
