...
pub fn software_stacks() -> &'static [SoftwareStack] {
    &[
        SoftwareStack {
            id: "ai-python",
            title: "AI & Python",
            description: "A local Python foundation for machine learning, automation and data work.",
            category: "AI",
        ...
        SoftwareStack {
            ...
            description: "JavaScript, source control and native build tools for modern web applications.",
        ...
        SoftwareStack {
            ...
            description: "Compiler, debugger and build-system essentials for native Linux software.",
            category: "Development",
        ...
        SoftwareStack {
            ...
            description: "Image, vector and 3D creation applications for visual production.",
            category: "Design",
        ...
        SoftwareStack {
            id: "productivity",
            title: "Productivity",
            description: "Office, document and archive tools for everyday work.",
...
pub fn stack_status(stack: &SoftwareStack, installed: &HashSet<&str>) -> StackStatus {
    StackStatus {
        installed: stack
            .packages
            .iter()
            .filter(|package| installed.contains(package.name))
            .count(),
...
pub fn filters_active(query: &str, category: &str) -> bool {
    !query.trim().is_empty() || (!category.is_empty() && category != ALL_STACK_CATEGORIES)
}
...
mod tests {
    ...
    fn filters_by_package_role_and_category() {
        assert_eq!(
            filter_stacks("debugger", ALL_STACK_CATEGORIES)[0].id,
            "native-development"
        );
